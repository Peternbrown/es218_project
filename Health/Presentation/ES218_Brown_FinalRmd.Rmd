...
library(tmap)
library(tibble) #need to load because add_column() requires it
...
ne.counties2 <- ne.counties %>%
  filter(Geo_FIPS %in% c("9001", "9003", "9005", "9007" , "9009" , "9011" , "9013" , "9015", "23001", "23003", "23005", "23007", "23009", "23011", "23013", "23015", "23017", "23019", "23021", "23023", "23025", "23027", "23029", "23031", "25001", "25003", "25005", "25007", "25009", "25011", "25013", "25015", "25017", "25019", "25021", "25023", "25025", "25027", "33001", "33003", "33005", "33007", "33009", "33011", "33013", "33015", "33017", "33019", "44001", "44003", "44005", "44007", "44009", "50001", "50003", "50005", "50007", "50009", "50011", "50013", "50015", "50017", "50019", "50021", "50023", "50025", "50027")) %>% 
...
ggplot(all.data, aes(x = income, y = `MHP per 100,000 people`)) + geom_point() + xlab("Median Household Income") +
  theme(axis.text.x = element_text(angle = 90)) + stat_smooth(method = "loess", se = FALSE, span = 0.7)
```

There appears to be slight positive relation between the two variables. The two peaks suggest that there is a threshold for ranges of that data. Mental healthcare providers per 100,000 people increases as income increases. Until around \$47,000, at which point it slightly declines, before rising again around \$52,000.


## Conclusion

After several analyses of New England mental health variables, it appears there is no relation between mental health and drug poisoning mortality rate. However, analysis does show that there might be a correlation between income in a state and access to mental health care providers per 100,000 people.
